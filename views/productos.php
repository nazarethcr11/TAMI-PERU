        ...
        <section class="productos__catalogo" id="catalogo1">
                ...
                <div class="productos__imagenes">
                    ...
                    <figure class="productos__item" id="S__Botellas">
                        <a href="#productos__tituloCatalogo" class="productos__link1">
                            <img class="productos__img" src="../public/images/catalogo_productos/SELLADORDEBOTELLAS.webp"
                                alt="SBotellas 1_1" /></a>
                    ...
                    <figure class="productos__item" id="maquina__embalaje">
                        <a href="#productos__tituloCatalogo" class="productos__link1">
                            <img class="productos__img" src="../public/images/catalogo_productos/MÁQUINADEEMBALAJE.webp"
                                alt="emabalaje" />
                        </a>
                        Máquina de embalaje
                        <figcaption class="productos__description">
                    ...
                    <figure class="productos__item" id="sellador__vasos">
                        <a href="#productos__tituloCatalogo" class="productos__link1">
                            <img class="productos__img" src="../public/images/catalogo_productos/SELLADORDEVASOS.webp"
                    ...
                    <figure class="productos__item" id="Selladora-de-bolsas">
                        <a href="#productos__tituloCatalogo" class="productos__link1">
                            <img class="productos__img" src="../public/images/catalogo_productos/SELLADORADEBOLSAS.webp"
            ...
            <div style="padding: 10px;">
                ...
                <div class="productos__imagenes">
                    ...
                    <figure class="productos__item" id="Soldadora-LINGBA-5">
                        <a href="#productos__tituloCatalogo" class="productos__link1">
                            <img class="productos__img" src="../public/images/catalogo_productos/SOLDADORALINGBA.webp"
                    ...
                    <figure class="productos__item" id="Soldadora-SPARK-3">
                        <a href="#productos__tituloCatalogo" class="productos__link1">
                            <img class="productos__img" src="../public/images/catalogo_productos/SOLDADORASPARK.webp"
                    ...
                    <figure class="productos__item" id="MEZCLADORA-DE-CONCRETO">
                        <a href="#productos__tituloCatalogo" class="productos__link1">
                            <img class="productos__img" src="../public/images/catalogo_productos/MezcladoraConcreto/1MezcladoraConcreto.webp"
                                alt="MEZCLADORA-DE-CONCRETO" /></a>
                        Mezcladora de Concreto

                        <figcaption class="productos__description">
                            <a href="#productos__tituloCatalogo" class="productos__link2"
                                onclick="openModal('MEZCLADORA-DE-CONCRETO')">Vista rápida</a>
                        </figcaption>
                    </figure>
            ...
            <div style="padding: 10px;">
                ...
                <div class="productos__imagenes">
                    ...
                    <a href="#productos__tituloCatalogo" class="productos__link1">
                        <img class="productos__img" src="../public/images/catalogo_productos/BAMBOOFIBERWALLBOARD.webp"
                            alt="Panel Fibra" /></a>
                    ...
                    <figure class="productos__item" id="Ventilador-Holografico">
                        <a href="#productos__tituloCatalogo" class="productos__link1">
                            <img class="productos__img" src="../public/images/catalogo_productos/VENTILADORHOLOGRÁFICO.webp"
                    ...
                    <a href="#productos__tituloCatalogo" class="productos__link1">
                        <img class="productos__img" src="../public/images/catalogo_productos/WPCFENCEPANEL.webp"
                    ...
                    <a href="#productos__tituloCatalogo" class="productos__link1">
                        <img class="productos__img" src="../public/images/catalogo_productos/WPCWALLPANEL.webp"
